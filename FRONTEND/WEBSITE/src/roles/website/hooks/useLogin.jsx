...
const useLogin = (handleLogin) => {
    ...
    const handleEmailLogin = async () => {
        ...
        setLoading(true);
        try {
            const res = await fetch(`${api_url}/api/website/auth/email`, {
                method: "POST",
    ...
    const handleVerifyOtp = async () => {
        setLoadingVotp(true);
        try {
            const res = await fetch(`${api_url}/api/website/auth/verify-otp`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    const handleRegister = async () => {
        ...
        setLoadingReg(true);
        try {
            const res = await fetch(`${api_url}/api/website/auth/register`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    role_id: 3,
