...
const ManageLeaves = ({ userInfo, handleLogout }) => {
    ...
    const handleApproveLeave = async (leaveId) => {
        try {
            ...
            const response = await axiosInstance.post(`${api_url}/api/admin/leave-requests/${leaveId}/approve`, {
    ...
    const handleSubmitReject = async () => {
        ...
        try {
            setActionLoading(true);
            const response = await axiosInstance.post(`${api_url}/api/admin/leave-requests/${selectedLeaveId}/reject`, {
