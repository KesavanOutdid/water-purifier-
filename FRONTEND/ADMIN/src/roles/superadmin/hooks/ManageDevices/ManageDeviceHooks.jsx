...
const useManageDevice = (userInfo) => {
    ...
    const fetchModels = async () => {
        try {
            const res = await axiosInstance.post(`${api_url}/api/admin/FetchProductModels`);
    ...
    const fetchDevices = async () => {
        setIsLoading(true);
        try {
            const res = await axiosInstance.post(`/${api_url}api/admin/FetchDeviceDetails`);
            if (res.data.status === 'Success') {
    ...
    const addStation = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await axiosInstance.post(`${api_url}/api/admin/AddDeviceDetails`, payload);
