...
const useManageUsers = (userInfo) => {
    ...
    const fetchUsers = useCallback(async () => {
        try {
            ...
            const url = isSeller ? `${api_url}/api/admin/users/by-district` : `${api_url}/api/admin/FetchUsers`;
    ...
    const handleAddUserSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axiosInstance.post(`${api_url}/api/admin/AddUsers`, payload);
    ...
    const handleSellerAssignSubmit = async (e) => {
        ...
        try {
            ...
            const url = assignMode === 'reassign' ? `${api_url}/api/admin/ReAssignSeller` : `${api_url}/api/admin/AssignSeller`;
