        ...
        try {
            if (userData.role_id === 3) {
                ...
                const [ordersResponse, devicesResponse, subscriptionResponse] = await Promise.all([
                    axiosInstance.post(`${api_url}/api/admin/FetchOrdersByUserId`, { user_id: userData.user_id }),
                    axiosInstance.post(`${api_url}/api/admin/FetchEndUserDevices`, { user_id: userData.user_id }),
                    axiosInstance.post(`${api_url}/api/app/enduserhome/getActiveSubscriptionDetails`, {
                ...
                // ===== Technician =====
                try {
                    const tasksResponse = await axiosInstance.post(`${api_url}/api/admin/FetchTechnicianTasksByUserId`, {
                        user_id: userData.user_id,
                        email: userData.email,
                    });
