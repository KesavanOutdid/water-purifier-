...
const useManageInstallation = (userInfo) => {
    ...
    const fetchOrders = async () => {
        ...
        const url = isSeller ? `${api_url}/api/admin/installations/by-district` : `${api_url}/api/admin/FetchSelectUserOrders`;
        const res = isSeller
    ...
    const fetchInstallationTasks = async () => {
        const isSeller = Number(userInfo?.role_id) === 4;
        const url = isSeller ? `${api_url}/api/admin/installations/by-district` : `${api_url}/api/admin/FetchSelectInstallationTask`;
        const res = isSeller
            ? await axiosInstance.get(url, { params: { district: userInfo?.district } })
            : await axiosInstance.post(url);
        return res.data?.data || [];
    ...
    const assignInstallation = async ({
        ...
        try {
            ...
            await axiosInstance.post(`${api_url}/api/admin/AssignInstallation`, payload);
    ...
    const reassignInstallation = async ({ task_id, technician_id }) => {
        try {
            ...
            await axiosInstance.post(`${api_url}/api/admin/ReAssignInstallation`, payload);
