...
const useManageServices = (userInfo) => {
    ...
    const fetchServiceTasks = async () => {
        ...
        const url = isSeller ? `${api_url}/api/admin/services/by-district` : `${api_url}/api/admin/FetchSelectServiceTask`;
        const res = isSeller
    ...
    const assignServiceTask = async ({
        ...
        try {
            ...
            await axiosInstance.post(`${api_url}/api/admin/AssignService`, payload);
    ...
    const reassignServiceTask = async ({
        ...
        try {
            ...
            await axiosInstance.post(`${api_url}/api/admin/ReAssignService`, payload);
